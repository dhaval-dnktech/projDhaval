...
protocol MyOfferWithImageCellDelegate {
    func btnMyOfferImageCell_GetAction(_ button:UIButton)
}

class MyOfferWithImageCell: UITableViewCell  {
    
    var offerdelegate: MyOfferWithImageCellDelegate! = nil
    ...
    @IBOutlet var btnImageClick: UIButton!
    ...
    @IBAction func btnGetAction(_ sender: UIButton) {
        self.offerdelegate.btnMyOfferImageCell_GetAction(sender)
    }
